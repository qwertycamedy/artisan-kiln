    ...
    <div>
      <div className="overflow-hidden border-2 border-border">
        <div className="grid grid-cols-[1.4fr_1fr_1fr_1fr_90px] border-b-2 border-border bg-[#EFE6D6]">
          {["Tile Collection", "Item", "Quantity", "Unit Price", "Actions"].map(
            (title) => (
              <div
                key={title}
      ...
      <div className="mt-5 flex items-start justify-between gap-6">
        <button className="flex items-center gap-4 border-2 border-border bg-[#EFE6D6] px-5 py-4 shadow-panel transition hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none">
